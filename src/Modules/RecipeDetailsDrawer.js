...
async function RecipeDetailsDrawer(event, section) {
  ...
  favBtn.setAttribute('data-id', recipeId);
  ...
  editBtn.setAttribute('data-id', recipeId);

  const delBtn = document.createElement('button');
  delBtn.classList.add('btn-del', 'button', 'drawer-btn-del');
  delBtn.setAttribute('data-id', recipeId);
  ...
  favBtn.addEventListener('click', (event) => {
    ...
    AddRemoveFavorite(id, section, 'drawer');
  });

  delBtn.addEventListener('click', () => {
    RemoveDataForm(recipeId, section);
  });
...
module.exports = RecipeDetailsDrawer;
